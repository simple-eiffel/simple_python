#!/usr/bin/env python3
"""
Start the Python IPC test server (TCP-based) and wait for it to be fully ready.
...
def main():
    ...
    server_script = os.path.join(script_dir, 'python_ipc_server.py')

    print(f"[LAUNCHER] Starting IPC server on port {port}...", file=sys.stderr)
